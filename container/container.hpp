...
/* ************************************************************************** */
// Classe template: ci interessa conoscere il dato contenuto nel LinearContainer.
// Ereditarietà virtuale: quando si andrà ad ereditare da LinearContainer, ci sarà una ereditarietà diretta dal Container.
...
public:
  ...
  // Funzioni virtuali: potrebbe essere ragionevole implementare nuovamente tali funzioni per questioni di efficienza.
  // Parola chiave "inline": richiede al compilatore (quando possibile) di ridurre al minimo il costo di chiamata della funzione. 
  // Parola chiave "const" : i metodi possono modificare i dati del contenitore ma, non devono modificare il contenitore stesso.
...
template<typename Data>
class DictionaryContainer : virtual public TestableContainer<Data> { // Per controllo esistenza di un valore (Search).
