...
bool List<Data>::Node::operator==(const Node& node) const noexcept {
    // FUNZIONE ANCHE: return (element == node.element);
...
//    std::cout << "Oggetto list deallocato!" << std::endl;
}

// COPY ASSIGNMENT
template<typename Data>
List<Data>& List<Data>::operator=(const List<Data>& lista) {
    List<Data>* templist = new List<Data>(lista); // Chiamata del costruttore di copia;
    std::swap(*templist, *this); 
    delete templist; // Bisogna deallocare dallo heap.
    return *this;
}
...
template<typename Data>
bool List<Data>::operator!=(const List<Data>& lista) const noexcept { return !(*this == lista); }

/* **************************************************************************************** */

template<typename Data> // COPIA DEL VALORE
...
template <typename Data>
void List<Data>::MapPostOrder(MapFunctor funct, void* par, Node* current) {
    // RICORSIVA IN CODA.
    if(current != nullptr) {
...
template <typename Data>
void List<Data>::FoldPostOrder(FoldFunctor funct, const void* par, void* accumulator, Node* current) const {
    // RICORSIVA IN CODA.
    if(current != nullptr) {
