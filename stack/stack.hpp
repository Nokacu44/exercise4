...
/* ************************************************************************** */
/* Non è un contenitore di dati lineare: l'accesso avviene solo in testa, di conseguenza non può estendere TestableContainer, LinearContainer, etc...
  --> Non potremo implementare neanche funzioni Map e funzioni Fold. */
template <typename Data> // INTERFACE.
