...
/* ************************************************************************** */
// COSTRUTTORE CON LINEARCONTAINER
...
template<typename Data>
inline bool QueueVec<Data>::operator!=(const QueueVec<Data>& queue) const noexcept { return !(*this == queue); }
...
template<typename Data>
inline bool QueueVec<Data>::Empty() const noexcept { return (testa == coda); }
