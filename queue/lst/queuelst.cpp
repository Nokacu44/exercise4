...
const Data& QueueLst<Data>::Head() const {
    if(size == 0) {
        ...
        // const Data& value = List<Data>::Front();
        // return value;
...
template<typename Data>
void QueueLst<Data>::Enqueue(const Data& data) { List<Data>::InsertAtBack(data); }

template<typename Data>
void QueueLst<Data>::Enqueue(Data&& data) { List<Data>::InsertAtBack(std::move(data)); }

template<typename Data>
void QueueLst<Data>::Clear() { List<Data>::Clear(); }
