...
template<typename Data>
Data& BinaryTreeVec<Data>::NodeVec::Element() noexcept { return element; }

template<typename Data>
const Data& BinaryTreeVec<Data>::NodeVec::Element() const noexcept { return element; }
...
// SCOPE PROTETTO: SERVE SCRIVERE "typename"
template<typename Data>
...
// COSTRUTTORE DI COPIA E DI MOVE + DISTRUTTORE
template<typename Data>
...
// COPY ASSIGNMENT E MOVE ASSIGNMENT
template<typename Data>
